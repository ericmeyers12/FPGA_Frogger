...
module nios_system_mm_interconnect_0 (
	...
	wire    [9:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> sdram_s1_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> to_hw_port_s1_agent:cp_valid
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> to_hw_port_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // to_hw_port_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [9:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> to_hw_port_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> to_hw_port_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> to_hw_port_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> to_sw_port_s1_agent:cp_valid
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> to_sw_port_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // to_sw_port_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [9:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> to_sw_port_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> to_sw_port_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> to_sw_port_s1_agent:cp_endofpacket
	...
	wire    [9:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> to_hw_sig_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> to_sw_sig_s1_agent:cp_channel
	...
	wire          to_hw_port_s1_agent_rp_valid;                                                       // to_hw_port_s1_agent:rp_valid -> router_008:sink_valid
	wire  [106:0] to_hw_port_s1_agent_rp_data;                                                        // to_hw_port_s1_agent:rp_data -> router_008:sink_data
	wire          to_hw_port_s1_agent_rp_ready;                                                       // router_008:sink_ready -> to_hw_port_s1_agent:rp_ready
	wire          to_hw_port_s1_agent_rp_startofpacket;                                               // to_hw_port_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          to_hw_port_s1_agent_rp_endofpacket;                                                 // to_hw_port_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          to_sw_port_s1_agent_rp_valid;                                                       // to_sw_port_s1_agent:rp_valid -> router_009:sink_valid
	wire  [106:0] to_sw_port_s1_agent_rp_data;                                                        // to_sw_port_s1_agent:rp_data -> router_009:sink_data
	wire          to_sw_port_s1_agent_rp_ready;                                                       // router_009:sink_ready -> to_sw_port_s1_agent:rp_ready
	wire          to_sw_port_s1_agent_rp_startofpacket;                                               // to_sw_port_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          to_sw_port_s1_agent_rp_endofpacket;                                                 // to_sw_port_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire    [9:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_005:sink1_channel
	...
	wire    [9:0] rsp_demux_005_src0_channel;                                                         // rsp_demux_005:src0_channel -> crosser_002:in_channel
	...
	wire    [9:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink5_channel
	...
	wire    [9:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> crosser_003:in_channel
	...
	wire          to_hw_port_s1_agent_rdata_fifo_src_valid;                                           // to_hw_port_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] to_hw_port_s1_agent_rdata_fifo_src_data;                                            // to_hw_port_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          to_hw_port_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_006:in_0_ready -> to_hw_port_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> to_hw_port_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> to_hw_port_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // to_hw_port_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> to_hw_port_s1_agent:rdata_fifo_sink_error
	wire          to_sw_port_s1_agent_rdata_fifo_src_valid;                                           // to_sw_port_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] to_sw_port_s1_agent_rdata_fifo_src_data;                                            // to_sw_port_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          to_sw_port_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_007:in_0_ready -> to_sw_port_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> to_sw_port_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> to_sw_port_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // to_sw_port_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> to_sw_port_s1_agent:rdata_fifo_sink_error
	wire          to_hw_sig_s1_agent_rdata_fifo_src_valid;                                            // to_hw_sig_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] to_hw_sig_s1_agent_rdata_fifo_src_data;                                             // to_hw_sig_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          to_hw_sig_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_008:in_0_ready -> to_hw_sig_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> to_hw_sig_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> to_hw_sig_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // to_hw_sig_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> to_hw_sig_s1_agent:rdata_fifo_sink_error
	wire          to_sw_sig_s1_agent_rdata_fifo_src_valid;                                            // to_sw_sig_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] to_sw_sig_s1_agent_rdata_fifo_src_data;                                             // to_sw_sig_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          to_sw_sig_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_009:in_0_ready -> to_sw_sig_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                                  // avalon_st_adapter_009:out_0_valid -> to_sw_sig_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                                   // avalon_st_adapter_009:out_0_data -> to_sw_sig_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                                  // to_sw_sig_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                                  // avalon_st_adapter_009:out_0_error -> to_sw_sig_s1_agent:rdata_fifo_sink_error
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (to_hw_port_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (to_hw_port_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (to_hw_port_s1_agent_rdata_fifo_src_ready),       //         .ready
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (to_sw_port_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (to_sw_port_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (to_sw_port_s1_agent_rdata_fifo_src_ready),       //         .ready
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (to_hw_sig_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (to_hw_sig_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (to_hw_sig_s1_agent_rdata_fifo_src_ready),        //         .ready
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (to_sw_sig_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (to_sw_sig_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (to_sw_sig_s1_agent_rdata_fifo_src_ready),        //         .ready
